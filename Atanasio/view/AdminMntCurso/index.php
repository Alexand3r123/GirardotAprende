...
<html lang="es">
  <head>
    ...
    <title>ATANASIO GIRARDOT GRADOS</title>
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          <a class="breadcrumb-item" href="#">Grados</a>
        </nav>
      </div>
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Grados</h4>
        <p class="mg-b-0">Configuración</p>
      </div>

      <div class="br-pagebody">
        <div class="br-section-wrapper">
            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Grados</h6>
            <p class="mg-b-30 tx-gray-600">Listado de Grados</p>
            ...
            <div class="table-wrapper"></div>
                ...
                <thead>
                    <tr>
                    <th class="wd-15p">AULAS</th>
                    <th class="wd-15p">GRADOS</th>
                    <th class="wd-15p">Fech.Inicio</th>
                    <th class="wd-20p">Fech.Fin</th>
                    <th class="wd-15p">Director de Grupo</th>
                    <th class="wd-10p"></th>
                    <th class="wd-10p"></th>
                    <th class="wd-10p"></th>
                    </tr>
