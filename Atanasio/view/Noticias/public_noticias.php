...
<body>
    ...
    <div class="blog-section">
        <div class="row">
            <div class="title">
                <a href="../../index.php"><img src="../../Images/Icon_house.svg" alt="Regresar" class="house-icon"></a>
                <img src="../../Images/title_noticias.svg" alt="" width="567" height="37">
            </div>
            <div class="home"> <a href="index.php"> <img src="Images/5929221_building_estate_home_house_property_icon.svg" alt="" srcset=""></a></div>
